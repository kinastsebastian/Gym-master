...
// --- PANTALLA DE INICIO DE SESIÓN ---
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none opacity-[0.04] blur-[1px] z-0 scale-150">
        <svg height="800px" width="800px" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" xml:space="preserve" className="text-zinc-500 w-96 h-96">
          <g fill="currentColor">
            ...
            <path d="M473.083,471.043c-49.189-54.872,6.308-141.266,6.308-261.065C479.391,90.18,382.903,0,263.104,0
            ...
            <path d="M346.97,386.537c-1.705-17.034,3.498-28.856,11.719-34.38c2.841-5.02,6.38-11.744,9.902-19.724
 ...
 return (
    <div className="min-h-screen bg-black text-zinc-300 p-3 font-sans pb-24 selection:bg-red-900 selection:text-white relative overflow-hidden">
      
      {/* SILUETA ESPARTANA FIJA DE FONDO */}
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none opacity-[0.02] blur-[1px] z-0 scale-[2.2]">
        <svg height="800px" width="800px" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" xml:space="preserve" className="text-zinc-500 w-96 h-96">
          <g fill="currentColor">
            <path d="M209.145,273.343c-8.941-6.364-17.106-12.295-23.094-16.882c-8.357-6.395-19.547-15.92-31.763-26.711
                c-12.223-10.79-25.447-22.83-37.654-34.084c-8.925-8.237-17.306-16.05-24.35-22.662L22.853,410.503l25.23-0.008l34.052-95.839
                ...
                <details key={ej.id} className="bg-zinc-900 border border-zinc-800 rounded-sm p-3 group">
                  <summary className="flex justify-between items-start cursor-pointer list-none focus:outline-none [&::-webkit-details-marker]:hidden">
                    ...
                    <div className="flex flex-shrink-0 items-center">
                      <button onClick={(e) => editarNombreEjercicio(ej, e)} className="text-zinc-600 hover:text-red-500 transition-colors px-2" title="Editar nombre">
                      ...
                      <div className="space-y-2">
                        ...
                        {ejerciciosTipo.map((item, index) => (
                          <div key={item.id} className="flex justify-between items-center bg-zinc-900 p-1.5 rounded-sm border border-zinc-800/50">
                            ...
                            <div className="flex flex-shrink-0 items-center">
<button onClick={(e) => editarNombrePlantilla(item, e)} className="text-zinc-600 hover:text-red-500 transition-colors px-2" title="Editar nombre">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-3.5 h-3.5">
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
  </svg>
</button>
